...
def calculate_mape(group, train_start_date, train_end_date, test_start_date, test_end_date):
    ...
    # 准备训练数据
    train_data = train_data[['install_day', 'cost', 'revenue', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']].rename(columns={'install_day': 'ds', 'revenue': 'y'})
    
    # 准备测试数据
    test_data = test_data[['install_day', 'cost', 'revenue', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']].rename(columns={'install_day': 'ds'})
    
    # 初始化并训练Prophet模型
    model = Prophet(weekly_seasonality=True)
    model.add_regressor('cost')
    model.add_regressor('lastweek_roi')
    model.add_regressor('lastweek_cpup')
    model.add_regressor('lastweek_arppu')
    ...
    train_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']] = scaler_X.fit_transform(train_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']])
    test_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']] = scaler_X.transform(test_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']])
    
    # 准备DNN的训练数据
    X_train = train_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']]
    y_train = train_data['y']
    
    # 准备DNN的测试数据
    X_test = test_data[['cost', 'weekly', 'lastweek_roi', 'lastweek_cpup', 'lastweek_arppu']]
