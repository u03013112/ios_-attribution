...
def debug_more2():
    ...
    for country in final_df['country'].unique():
        ...
        # 打印国家及其相关系数矩阵
        print('\n', country)
        print('>>applovin_int_cost corr:')
        print(correlation_matrix['applovin_int_cost'])
        print('>>applovin_int_ROI corr:')
        print(correlation_matrix['applovin_int_ROI'])

        # print(f"\n与applovin花费金额相关系数 {country}:")
        # print(correlation_matrix.loc[['Facebook Ads_cost', 'googleadwords_int_cost', 'Facebook Ads_revenue', 'googleadwords_int_revenue', 'Facebook Ads_ROI', 'googleadwords_int_ROI'], 'applovin_int_cost'])
        
        # print(f"\n与applovin回收金额相关系数 {country}:")
        # print(correlation_matrix.loc[['Facebook Ads_cost', 'googleadwords_int_cost', 'Facebook Ads_revenue', 'googleadwords_int_revenue', 'Facebook Ads_ROI', 'googleadwords_int_ROI'], 'applovin_int_revenue'])
        
        # print(f"\n与applovin ROI相关系数 {country}:")
        # print(correlation_matrix.loc[['Facebook Ads_cost', 'googleadwords_int_cost', 'Facebook Ads_revenue', 'googleadwords_int_revenue', 'Facebook Ads_ROI', 'googleadwords_int_ROI'], 'applovin_int_ROI'])
