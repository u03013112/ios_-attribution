...
def totalAndPlatformCountry():
    ...
    ax1.plot(JP_AOSDf['install_day'], JP_AOSDf['KPI'], label='KPI', color='blue')
    ax1.plot(JP_AOSDf['install_day'], JP_AOSDf['sum_7roi'], label='sum 7roi', color='green')
    ...
    ax3 = ax2.twinx()
    ax3.fill_between(JP_AOSDf['install_day'], JP_AOSDf['sum_cost_ok'], color='green', alpha=0.5, label='sum cost ok')
    ...
    ax1.xaxis.set_major_locator(mdates.DayLocator(interval=1))
    ax1.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m-%d'))
    ax1.plot(JP_IOSDf['install_day'], JP_IOSDf['KPI'], label='KPI', color='blue')
    ax1.plot(JP_IOSDf['install_day'], JP_IOSDf['sum_7roi'], label='sum 7roi', color='green')
    ax1.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax1.set_ylabel('ROI')
    ...
    ax2.set_ylabel('daily cost')
    ax3 = ax2.twinx()
    ax3.fill_between(JP_IOSDf['install_day'], JP_IOSDf['sum_cost_ok'], color='green', alpha=0.5, label='sum cost ok')
    ax3.legend(loc='upper right')
    ax3.set_ylabel('sum cost ok')
    ax2.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax2.set_xlabel('Install Day')
    ...
    ax1.xaxis.set_major_locator(mdates.DayLocator(interval=1))
    ax1.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m-%d'))
    ax1.plot(NOJP_AOSDf['install_day'], NOJP_AOSDf['KPI'], label='KPI', color='blue')
    ax1.plot(NOJP_AOSDf['install_day'], NOJP_AOSDf['sum_7roi'], label='sum 7roi', color='green')
    ax1.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax1.set_ylabel('ROI')
    ...
    ax2.set_ylabel('daily cost')
    ax3 = ax2.twinx()
    ax3.fill_between(NOJP_AOSDf['install_day'], NOJP_AOSDf['sum_cost_ok'], color='green', alpha=0.5, label='sum cost ok')
    ax3.legend(loc='upper right')
    ax3.set_ylabel('sum cost ok')
    ax2.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax2.set_xlabel('Install Day')
    ...
    ax1.xaxis.set_major_locator(mdates.DayLocator(interval=1))
    ax1.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m-%d'))
    ax1.plot(NOJP_IOSDf['install_day'], NOJP_IOSDf['KPI'], label='KPI', color='blue')
    ax1.plot(NOJP_IOSDf['install_day'], NOJP_IOSDf['sum_7roi'], label='sum 7roi', color='green')
    ax1.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax1.set_ylabel('ROI')
    ...
    ax2.set_ylabel('daily cost')
    ax3 = ax2.twinx()
    ax3.fill_between(NOJP_IOSDf['install_day'], NOJP_IOSDf['sum_cost_ok'], color='green', alpha=0.5, label='sum cost ok')
    ax3.legend(loc='upper right')
    ax3.set_ylabel('sum cost ok')
    ax2.axvline(x=full7dayEndDate, color='orange', linestyle='--', label='full7dayEndDate')
    ax2.set_xlabel('Install Day')
