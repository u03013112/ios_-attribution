...
1、上周期摘要：总体表现好，特别是KR和other高出比例较大，可以考虑适当放量。
    注意：只关注ROI7列，上个周期的ROI7是完整数据。
2、上周期到本周期操作点评：主要花费变化在GCC地区花费大幅增加，符合一般规律。
3、本周期目前情况与建议：ROI1和ROI3方面，与折算KPI比较，也是基本满足KPI的，其中JP、other在本周表现很好，可以适度放量。
