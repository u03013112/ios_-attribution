...
1、上周期摘要：总体表现(好or不好or一般)，特别是XX(上周期ROI7 XX%,比KPI要求的XX% 高or低了XX%)高于or低于KPI比例较大，可以根据个人经验，酌情考虑适当放量or减量。
    注意：只关注ROI7列，上个周期的ROI7是完整数据。只关注高于or低于KPI比例大于20%的数据，比例小于等于20%数据不要出现在分析里！
2、上周期到本周期操作摘要：主要花费变化在XX（如果有多个就放一起写）地区花费大幅增加or减少。
    注意：主要关注花费变化大的地区，环比差距在20%以上的，花费变化小的地区不要出现在分析里！
3、本周期目前情况与建议：ROI1、ROI24h和ROI3方面，与折算KPI比较，YY满足or不满足KPI的，其中XX（如果有多个就放一起写）在本周表现很好（或者不好），可以根据个人经验，酌情考虑适度放量（减量）。
    注意：本周期的ROI7是不完整数据。所以主要关注ROI3、ROI24h。
    注意：YY是大部分的国家和地区，比如目前是5个国家地区，那就是3个国家地区满足KPI，2个国家地区不满足KPI。其中YY用多数地区代码替代，最多写3个多家地区代码，大于3个用“等”表达。
    注意：小部分地区用XX代替，如果全部国家地区都是满足或者不满足，即没有小部分地区，那就不要再有后面 “其中XX” 及以后的内容了。用建议性的措辞来概括即可。比如建议适度整体放量或者减量。
    注意：只有高于KPI才算是表现好，低于KPI才算是表现不好，如果没有大幅高于或低于KPI，就不好再有后面 “可以根据个人经验，酌情考虑适度放量（减量）” 及以后的内容了。用建议性的措辞来概括即可。比如建议适度整体放量或者减量。
