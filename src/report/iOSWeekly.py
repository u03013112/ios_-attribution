...
def macdAnalysis(df,target='ROI_1d',startDayStr='20231001',endDayStr='20231007', analysisDayCount=7):
    ...
    # 保存图像到文件
    picFilename = getFilename(f'{startDayStr}_{endDayStr}_{target}_macd', 'png')
...
\begin{figure}[!h]
    \centering
    \includegraphics{''' + f'./{startDayStr}_{endDayStr}_{target}_macd.png'+'''}
\end{figure}
\FloatBarrier
    '''
