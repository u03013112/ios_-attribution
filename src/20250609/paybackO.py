...
roi AS (
	SELECT
		...
		revenue_d120,
		revenue_d150
	FROM dws_overseas_roi_profit roi
...
from lw_20250815_country_milestone_profit_payback_view_by_j pred
left join lw_20250815_country_milestone_profit_real_payback_view_by_j real
