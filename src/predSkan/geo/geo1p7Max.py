...
##@resource_reference{"geoMaxMod20221124.zip"}
...
def predict(dayStr):
    with zipfile.ZipFile('geoMaxMod20221124.zip') as myzip:
        for geo in geoList:
            name = geo['name']
...
def createTable():
    ...
    table = o.create_table('topwar_iosglobal_geo1p7_max200', schema, if_not_exists=True)
    return table

# import pyarrow as pa
def writeTable(df,dayStr):
    t = o.get_table('topwar_iosglobal_geo1p7_max200')
