...
from src.predSkan.attrbution.customLayer.createMod import createModEasy04_l2
...
def main():
    ...
    # np.save('/src/data/customLayer/a_xR7.npy',x)
    # np.save('/src/data/customLayer/a_yR7.npy',y)

    x = np.load('/src/data/customLayer/a_xR7.npy')
    y = np.load('/src/data/customLayer/a_yR7.npy')
