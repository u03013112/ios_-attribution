...
def train(dataDf3,message):
    ...
    for _ in range(10):
        for media in mediaList:
            ...
            trainX,mean,std,trainY,trainY0,trainY1 = getTrainingData(dataDf3,name,'2022-05-01','2022-08-01')
            testX, testY, testY0, testY1 = getTestingData(dataDf3,name,'2022-08-01','2022-10-01',mean,std)
...
if __name__ == '__main__':
    if __debug__:
        ...
        df2 = dataFill(df1)
        df2.to_csv(getFilename('mediaIdfaMax200_20220501_20220930'))
        
    df = pd.read_csv(getFilename('mediaIdfaMax200_20220501_20220930'))
    train(df,'mse max media function1 without dropout long date')
