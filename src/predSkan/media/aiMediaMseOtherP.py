...
from src.predSkan.tools.ai import purgeRetCsv,logUpdate,createDoc,filterByMediaName2
...
def train(dataDf3,message):
    ...
    for _ in range(5):
        for media in mediaList:
            ...
            trainX, trainY, testX, testY, trainY0, testY0, trainY1, testY1 = filterByMediaName2(dataDf3,name)
