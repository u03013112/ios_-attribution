...
def getAndroidData(sinceTimeStr,unitlTimeStr):
    ...
    sql = '''
        ...
        group by
            ...
            install_date
        ;
    '''%(whenStr,sinceTimeStr2,unitlTimeStr2,sinceTimeStr2,unitlTimeStr2,sinceTimeStr2,unitlTimeStr2)
...
if __name__ == '__main__':
    if __debug__:
        ...
        df4 = dataStep3(df)
        df4.to_csv(getFilename('AndroidData3_20220501_20221215'))

    df4 = pd.read_csv(getFilename('AndroidData3_20220501_20221215'))
    train(df4,'android total 3')