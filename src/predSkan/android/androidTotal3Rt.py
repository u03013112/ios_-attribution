...
if __name__ == '__main__':
    if __debug__:
        ...
        df = mergeData1AndData2('20220501','20230201')
        df4 = dataStep3(df)
        df4.to_csv(getFilename('AndroidDataRt3_20220501_20230201'))

    df4 = pd.read_csv(getFilename('AndroidDataRt3_20220501_20230201'))
    train(df4,'android total 3p7 func2 rt 1713')