...
def train(dataDf3,message):
    ...
    for _ in range(10):
        ...
        testX, testY, testY0, testY1 = getTestingData(dataDf3,'2022-09-01','2022-10-30',mean,std)

        meanDf = pd.DataFrame(data = {
            'mean':list(mean)
        })
        meanDf.to_csv('/src/data/totalMean20220501_20220731.csv')

        stdDf = pd.DataFrame(data = {
            'std':list(std)
        })
        stdDf.to_csv('/src/data/totalStd20220501_20220731.csv')
...
if __name__ == '__main__':
    ...
    # df4 = dataStep4(df)
    # df4.to_csv(getFilename('totalData_20220501_20220930'))
