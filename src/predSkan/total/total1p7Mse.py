...
##@resource_reference{"totalMod20221124.zip"}
...
def predict(dayStr):
    name = 'total'
    with zipfile.ZipFile('totalMod20221124.zip') as myzip:
...
def createTable():
    ...
    table = o.create_table('topwar_iosglobal_total1p7_mse', schema, if_not_exists=True)
    return table

# import pyarrow as pa
def writeTable(df,dayStr):
    t = o.get_table('topwar_iosglobal_total1p7_mse')
