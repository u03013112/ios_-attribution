...
if __name__ == '__main__':
    df3 = pd.read_csv('/src/data/totalDataRt_3_20220701_20230201.csv')
    df3 = df3.loc[df3.install_date == '2022-07-02']
    ...
    trainXLoad = np.load('/src/data/doc/total/total_20230209_111219/trainX.npy')
    print(trainXLoad[1])

    # y = trainDf.groupby('install_date').agg('sum')
    # print(y)


    print(predict('/src/data/doc/total/total_20230209_111219',trainX))
