...
def createAosAllFuncView():
    sql = """
CREATE OR REPLACE VIEW lw_20250903_aos_all_func_view_by_j as
SELECT
*
...
SELECT
*
FROM lw_20250903_aos_gpir_cohort_avg_56_view_by_j
;
    """
    print(f"Executing SQL: {sql}")
    execSql2(sql)
...
from lw_20250903_aos_all_func_view_by_j
;
    """
    print(f"Executing SQL: {sql}")
    execSql2(sql)
...
def createReadAndPredictRevenueView():
    sql = """
CREATE OR REPLACE VIEW lw_20250903_read_and_predict_revenue_view_by_j as
SELECT
    app_package,
    country_group,
    mediasource,
