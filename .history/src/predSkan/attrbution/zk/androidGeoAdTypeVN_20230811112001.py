...
adTypeMap = {
    'FB AAA':['23852840064440120','23853511193320120','23854138666660120'],
    'FB BAU':['23852982929260120','23853378021980120','23854202804040120'],
    'GG UAC':['19656586712','20152427906'],
    'TT AEO':['1762483312826369','1764141259843602'],
    'TT VO':['1762861889722402','1763935034545201','1765021295118370','1765114778978353','1765956333239346','1766768942381057','1768753015675937'],
    'unknown':['1768753015675937']
}
...
def loadData():
    ...
    # 将campaign_id 按照 adTypeMap 映射为 ad type，并覆盖到 campaign_id 列
    for adType in adTypeMap:
        campaignIdList = adTypeMap[adType]
        df.loc[df['campaign_id'].isin(campaignIdList),'campaign_id'] = adType
