...
def main():
    ...
    df.loc[df['media_source']=='Facebook Ads', 'ad type'] = 'FB AAA'
    # media_source = ‘Facebook Ads’ 的广告，campaign 包含 ‘BAU’ 的，ad type = ‘FB BAU’
    df.loc[df['media_source']=='Facebook Ads', 'ad type'] = 'FB BAU'
    # media_source = ‘bytedanceglobal_int’ 的广告，campaign 包含 ‘VO’，ad type = ‘TT VO’
    df.loc[df['media_source']=='bytedanceglobal_int', 'ad type'] = 'TT VO'
    # media_source = ‘bytedanceglobal_int’ 的广告，campaign 包含 ‘AEO’，ad type = ‘TT AEO’
    df.loc[df['media_source']=='bytedanceglobal_int', 'ad type'] = 'TT AEO'
